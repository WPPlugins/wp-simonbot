...
<div class="hero-unit">
<?php
  echo '<p>A cluster has been added to your Simonbot account. The cluster is named : "'.$cluster['name'].'" and you can visualize it either <a href="https://simonbot.com/watchers/clusters/'.$cluster['_id'].'/dashboard">on your Simonbot account</a> or in Simonbot for Wordpress.</p>';
?>
</div>
</div>
</div>
